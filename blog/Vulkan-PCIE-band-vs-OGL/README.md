...
| Render | FPS | PCI-E usage RX/TX | Screenshot |
|-------------|------------|------------|------------|
| OpenGL | 147 | RX: 719MiB TX: 81MiB | <img src="OGL_PCIE_band.png" width="650" height="auto" /> |
| Vulkan 1 frame in flight | 50 | RX: 401MiB TX: 86MiB | <img src="Vk_1-frame_PCIE_band.png" width="650" height="auto" /> |
| Vulkan 2 frames in flight | 85 | RX: 565MiB TX: 131MiB | <img src="Vk_2-frame_PCIE_band.png" width="650" height="auto" /> |
...
Video played in Chrome that use OpenGL as WebGL render. `chrome.exe --use-angle=gl`
*because Vulkan WebGL Chrome render has way too much overhead so it result more than 10x slower performance compare to OpenGL, and 4k video lags in Vulkan in Chrome*
*look below where I watlk about Vulkan WebGL*
...
This size of canvas still work in 60 FPS in Vulkan, but in fullscree it is slideshow - obviously Chrome issue/bug.
